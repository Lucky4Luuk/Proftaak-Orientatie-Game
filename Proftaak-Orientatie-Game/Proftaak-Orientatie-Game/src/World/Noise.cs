...
namespace Proftaak_Orientatie_Game.World
{
    ...
    {
        public static float Calc1D(float x, float scale)
        {
            return Generate(x * scale);
        }

        public static float Calc2D(float x, float y, float scale)
        {
            return Generate(x * scale, y * scale);
        }

        public static float Calc3D(float x, float y, float z, float scale)
        {
